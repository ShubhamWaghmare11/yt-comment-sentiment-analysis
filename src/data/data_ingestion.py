...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    # Save the train and test datasets, creating the raw folder if it dosen't exist.
...
def main():
    try:
        ...
        train_data,test_data = train_test_split(final_df,test_size=test_size, random_state=52)
        ...
        logger.error("failted to complete the data ingestion process: %s", e)
